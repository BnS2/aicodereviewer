...
type _CoercedEnvSchema_8f9a8810 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_8f9a8810> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_8f9a8810, 'BETTER_AUTH_URL' | 'PUBLIC_APP_URL' | 'NODE_ENV' | 'PORT' | 'NETLIFY_URL' | 'GITHUB_CLIENT_ID'>> {}
}
...
type _EnvSchemaAsStrings_8f9a8810 = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_8f9a8810 {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_8f9a8810 {}
  }
}