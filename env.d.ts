...
type _CoercedEnvSchema_14e397ea = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_14e397ea> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_14e397ea, 'NODE_ENV' | 'PORT' | 'NETLIFY_URL'>> {}
}
...
type _EnvSchemaAsStrings_14e397ea = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_14e397ea {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_14e397ea {}
  }
}